  ...
  var HeaderDesktop = /*#__PURE__*/function () {
    ...
    _createClass(HeaderDesktop, [{
      ...
      value: function initialize() {
        ...
        this.navLinkElements = Array.from(this.headerElement.querySelectorAll(".header-desktop__nav-link")).filter(function (element) {
        ...
        this.navLinkElements.forEach(function (dropdownLink) {
          dropdownLink.classList.add("is-dropdown-link");
        });
        var allDropdownLinkElements = [].concat(_toConsumableArray(this.dropdownLinkElements), _toConsumableArray(this.navLinkElements));
