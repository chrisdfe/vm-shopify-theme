(function () {
  ...
  function hideNavbar() {
    $("body").removeClass("is-active").removeClass("blocked-scroll"), $(".dropdown_link").toggleClass("active_link"), $(".cart_container").removeClass("active_link");
  }
  ...
  var header = {
    init: function init() {
      ...
      $("html").on("click", function (e) {
        if (!$(e.target).closest(".cart_container").length && $(".cart_content").is(":visible")) {
          ...
          if ($(e.target).closest(".dropdown_container").length && $(".dropdown").is(":visible") && !$(e.target).hasClass("url-deadlink")) {
      ...
      $(".dropdown_link").on("mouseover touchstart", function (e) {
        ...
        var a = $(this).attr("data-click-count");
    ...
    removeDataAttributes: function removeDataAttributes(selector) {
      var element = $(selector);

      if (element.length) {
        var dataAttributes = [];
        var attributes = a.get(0).attributes;
    ...
    loadMegaMenu: function loadMegaMenu() {
      ...
      this.removeDataAttributes(".sticky_nav .mega-menu.dropdown_container .dropdown_column");
      $(".mega-menu-container .mega-menu").each(function (e) {
        var t = $(this).data("dropdown");
        $('[data-dropdown-rel="' + t + '"]').find("span").remove();
        $('[data-dropdown-rel="' + t + '"]').not(".icon-search").append(' <span class="icon-down-arrow"></span>').addClass("mega-menu-parent").addClass("dropdown_link").removeClass("top_link");
    ...
    loadMobileMegaMenu: function loadMobileMegaMenu() {
      $(".mega-menu-container .mobile-mega-menu").each(function (e) {
        ...
        $('[data-mobile-dropdown-rel="' + $(this).data("mobile-dropdown") + '"] > ul').each(function (e) {
